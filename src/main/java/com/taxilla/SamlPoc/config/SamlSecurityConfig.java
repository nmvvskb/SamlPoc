...
//import com.taxilla.SamlPoc.utils.PropertyUtil;
...
//
//    protected Map<String, JSONPObject> idpMap = new HashMap<>();
//
//    /**
...
//        File metadata = null;
//        try {
//            //metadata = new File("./src/main/resources/saml/metadata/okta.xml");
//            metadata = new File("./src/main/resources/saml/metadata/taxilla1_jp_auth0_com-metadata.xml");
//        } catch (Exception e) {
//            e.printStackTrace();
//        }
...
//     * we've parsed the metadata from the okta.xml file that contains the IdP metadata XML,
...
//        System.out.println("metadata() in SAMLSecurityConfig");
//        List<MetadataProvider> providers = new ArrayList<>();
//        providers.add(oktaExtendedMetadataProvider());
//        CachingMetadataManager metadataManager = new CachingMetadataManager(providers);
//        String defaultIdp=getEndPointURL();
//        metadataManager.setDefaultIDP(defaultIdp);
//        return metadataManager;
//    }
//
//    private String getEndPointURL() {
//        String idp = propertyUtil.getProperty(SamlConstants.saml_autho_idp_entity_id);
//        return idp;
//    }
//
//    @Bean
